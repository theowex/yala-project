                            ...
                            <div className="wrap-heading flat-slider flex">
                                <div className="content">
                                    ...
                                    <div className="flat-bt-slider flex style2">
                                        <Link to="/explore-01" className="sc-button header-slider style style-1 rocket fl-button pri-1"><span>Explorar
                                        </span></Link>
                                        <Link to="/create-item" className="sc-button header-slider style style-1 note fl-button pri-1"><span>Crear subasta
                                        </span></Link>
                                    </div>
                                </div>
                                <div className="image">
